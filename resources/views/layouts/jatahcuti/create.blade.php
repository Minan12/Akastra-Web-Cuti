...
@section('content')
    <div class="main-content">
        <section class="section">
            ...
            <div class="card">
                <form action="{{ route('jatahcuti/store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control datepicker" name="tgl_mulai_cuti" id="tgl_mulai_cuti" placeholder="tgl Lahir">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control datepicker" name="tgl_akhir_cuti" id="tgl_akhir_cuti" placeholder="tgl Lahir">
